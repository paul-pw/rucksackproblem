...
Ob sich \(\mathcal{NP}\)-vollständige Probleme in \(\mathcal{P}\) Probleme umformen lassen,
...
%% TODO schauen, dass code auszug nicht von Tabelle zerstört wird.
...
kann aber ein voll polynomielles Approximationsverfahren geschaffen werden.
...
damit ist die Laufzeit des Algorithmus in Abschnitt~\ref{sec:dyn_opt} \(O()\)
